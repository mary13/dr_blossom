...
// script added by NET MAN 9/14/01 set 31-day cookie for GoTo keywords KAushal
...
function setKeyword(name) {
 ...
 // Below line sets cookie for one month

 expdate.setTime(expdate.getTime() + (24 * 60 * 60 * 1000 * 31));

   SetCookie("keyword", name, expdate, "/", "61.17.38.19:8080", false);

}



// function CheckMe() { // Only needed as a function if it isn't working right

// added by NETMAN 7/26/02 for discrete pages in promotional use

// replaces old Body onLoad manual coding

// Pull in this page by external js SRC, and put it in the /ck directory

function itementry(page,key) {
...
se[0] = new itementry("_goo.htm","_google");

se[1] = new itementry("_fw.htm","_findwhat");

se[2] = new itementry("_ah.htm","_aha");

se[3] = new itementry("_ov.htm","_overture");

se[4] = new itementry("_yh.htm","_yahoo");
...
//xmlhttp.open("GET","/joomla_k2/modules/mod_prak/mod_prak.php?vata="+vata+"pitta"+pitta+"kapha"+kapha,true);

//xmlhttp.open("GET","/modules/mod_prak/mod_prak.php?vata="+vata+"&pitta="+pitta+"&kapha="+kapha+"$type="+type,true);

//xmlhttp.open("GET","/modules/mod_prak/mod_prak.php?vata="+vata+"&pitta="+pitta+"&kapha="+kapha,true);

//xmlhttp.open("GET","/modules/mod_prak/mod_prak.php?vata="+vata+"&pitta="+pitta+"&kapha="+kapha+"&high="+high+"&mtype="+mtype,true);

xmlhttp.open("GET","http://doctorblossom.com/index.php?vata="+vata+"&pitta="+pitta+"&kapha="+kapha+"&high="+high+"&mtype="+mtype,true);
...
mywin = window.open("","win",'toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=430,height=400');

mywin.location.href = "http://www.banyanbotanicals.com/constitutions/welch_bio_pop.html";
...
mywin = window.open("","win",'toolbar=1,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=490,height=400');

mywin.location.href = "http://www.banyanbotanicals.com/gifs/catalogcover.jpg";

}

// Added 3/17/02 by NET MAN for recommend pop-up window

function recWin() {

mywin = window.open("","win",'toolbar=1,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=440,height=400');

mywin.location.href = "http://www.banyanbotanicals.com/recommend_js.html";
